...
def test__DecisionV1Factory(decisions_corpus_gold):
    ...
    assert len(document.paragraphs) == 39
    assert document.paragraphs[19].paragraph_mark == '20.'
    assert document.paragraphs[
               13].text == 'However, rather than proceed with the printing of the annual premium statements,  ' \
    ...
    # Test footnotes
    assert document.paragraphs[37].text[900:950] == ' of Section 24 of the PDPA (The  Commission’s deci'
